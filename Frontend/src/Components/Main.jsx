...
//   return (
//     <div className="w-full" style={{ background: "var(--color-bg)" }}>
//       {/* // Section Of Of introduction And input In which Get user opinion */}
...
//           className="absolute inset-0 bg-cover bg-center m-10 rounded-4xl mt-20"
//           style={{
//             backgroundImage: "url('090846e8bea467388a24988b6239e86d.jpg')",
//           }}
//         >
//           {/* Overlay */}
//           <div className="absolute inset-0 "></div>
...
//           <button
//             onClick={() => setOpen(true)}
//             className="px-6 py-3 bg-green-600 hover:bg-green-700 rounded-full text-lg transition-all duration-300"
//           >
//             Create Message
//           </button>
//         </div>
...
//       {/* // Section of User opinion on authentication Messages */}

//       <div className="px-3 md:px-12 py-12 m-4 bg-[#0f1117] rounded-4xl">
//         {/* Heading */}
//         <div className="text-center mb-12">
