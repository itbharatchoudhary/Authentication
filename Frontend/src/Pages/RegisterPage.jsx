...
const Register = () => {
  return (
    <AuthLayout>
      <div className="flex items-center justify-center min-h-screen bg-black px-6 p-15 ">
        
        <div className="w-full max-w-md bg-black border border-white/10 rounded-2xl p-8 shadow-[0_0_40px_rgba(255,255,255,0.05)]">

          {/* TITLE */}
          <h2 className="text-3xl font-semibold mb-12 text-center text-white tracking-wide">
            Create Account
          </h2>
          ...
          {/* REGISTER BUTTON */}
          <button className="w-full py-3 rounded-lg bg-white text-black font-medium hover:bg-white/30  border border-white transition duration-300">
            Register
          </button>
          ...
          <p className="text-center text-sm text-white/40 mt-6">
            ...
            <Link to="/login" className="text-white underline hover:opacity-80">
              Login
            </Link>
          </p>
